            ...
            >
              ...
              >
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  onClick={onComplete}
                  className="bg-gradient-to-r from-primary to-secondary text-primary-foreground px-6 py-3 rounded-lg neon-border hover:animate-glow transition-all duration-300 font-bold pointer-events-auto"
                ...
                <motion.button
                  ...
                  className="bg-gradient-to-r from-accent to-neon-gold text-accent-foreground px-6 py-3 rounded-lg neon-border hover:animate-glow transition-all duration-300 font-bold pointer-events-auto"
